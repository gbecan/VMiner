...
public class FeatureClustering {
	...
	public Map<List<String>, String> clusterFeatures(CustomStringList valFeat)
			throws IOException, InterruptedException, ClassNotFoundException {
		frame = new JFrame("Clustering Features");
	...
	/*	for(String feature: valFeatures){
		...
		FRGDemo FRGContentPane = new FRGDemo(similarityMap, valFeatures);
		...
		ClusteringSimFeaturesDemo clusterContentPane = new ClusteringSimFeaturesDemo(
				similarityMap, valFeatures, FRGContentPane.getFeaturesTrans());
		...
		Process p = Runtime.getRuntime().exec(
				"Rscript /home/user/Rtest/valClustersFIS.R");
		String s = null;
		...
		Map<List<String>, String> FIS = getCommonPartByCluster(valFeatures,
				"/home/user/FinalSpace/VMiner/R statistics new/ValFeatures/clustersFIS.csv");
