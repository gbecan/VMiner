...
<xsl:template match="/">
  ...
  <body>
    ...
    <tr><th>Coreference resolution links</th></tr>
    <tr><td>
...
<xsl:template match="link">
  <li><i>source </i> 
      (sentence <xsl:value-of select="source/@sentence"/>, 
       token <xsl:value-of select="source/@token"/>)
      --
      <i>destination </i>
      (sentence <xsl:value-of select="destination/@sentence"/>, 
       token <xsl:value-of select="destination/@token"/>)
  </li>
</xsl:template>
